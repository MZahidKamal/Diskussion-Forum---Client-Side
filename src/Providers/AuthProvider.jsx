    ...
    const signUpNewUser = async (name, photoUrl, email, password) => {
        try {
            ...
            const userInfoForDatabase = {
                ...
                role: 'user',                                   //Either 'user', 'admin' or 'pending'.
                membershipType: 'bronze',                       //Either 'bronze', 'gold' or 'pending'.
                joinDate: new Date().toISOString(),
                createdPosts: [],                               //Array of post ids created by this user.
                createdComments: [],                            //Array of comment ids created by this user.
                createdAnnouncements: [],                       //Array of announcement ids created by this user.
                viewedPosts: [],                                //Array of post ids viewed by this user.
                upVotedPosts: [],                               //Array of post ids up-voted by this user.
                downVotedPosts: [],                             //Array of post ids down-voted by this user.
                reportedComments: [],                           //Array of comment ids reported by this user.
            };
